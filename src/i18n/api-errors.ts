...
const messages: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    registration_unavailable: '注册服务暂时不可用。',
    registration_rate_limited: '验证码发送过于频繁，请稍后再试。',
    verification_code_invalid: '验证码错误或已失效，请重新获取。',
    terms_required: '请先同意账号服务条款与隐私说明。',
  ...
  en: {
    ...
    registration_unavailable: 'Account registration is temporarily unavailable.',
    registration_rate_limited: 'Too many verification requests. Try again later.',
    verification_code_invalid: 'The verification code is incorrect or expired.',
    terms_required: 'Accept the account terms and privacy notice to continue.',
