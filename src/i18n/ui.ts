...
export const ui = {
  'zh-CN': {
    ...
    'download.history.prerelease': '预发布',
    'download.history.published': '发布于 {date}',
    'download.history.notes': '更新说明',
    'download.history.downloads': '该版本安装包',
    'download.history.packages': '{count} 个安装包',
    'download.history.emptyNotes': '此版本未提供更新说明。',
    'download.history.emptyDownloads': '此版本未提供桌面安装包。',
    'download.history.error': '版本记录暂时无法载入。',
    'download.history.selectLabel': '选择版本',
  ...
  en: {
    ...
    'download.history.prerelease': 'Pre-release',
    'download.history.published': 'Released {date}',
    'download.history.notes': 'Release notes',
    'download.history.downloads': 'Installers for this release',
    'download.history.packages': '{count} installers',
    'download.history.emptyNotes': 'No release notes were provided for this version.',
    'download.history.emptyDownloads': 'No desktop installers were provided for this version.',
    'download.history.error': 'Release history is temporarily unavailable.',
    'download.history.selectLabel': 'Select a release',
