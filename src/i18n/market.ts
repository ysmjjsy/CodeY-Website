...
const copy = {
  'zh-CN': {
    ...
    archiveHint: '仅支持包含 marketplace/manifest.json 的 .codeypkg。文件大小上限由市场服务配置。',
    inspect: '上传并校验',
    inspecting: '正在校验…',
    package: '包',
    primaryResource: '主资源',
  ...
  en: {
    ...
    archiveHint: 'Only .codeypkg files containing marketplace/manifest.json are accepted. The server configures the maximum size.',
