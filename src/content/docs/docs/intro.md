...
:::caution[开发阶段]
CodeY 正处于 `0.2.x` 活跃开发阶段。安装包和版本记录通过 [GitHub Releases](https://github.com/ysmjjsy/CodeY/releases) 发布；没有适合当前平台的安装包时，请[从源码构建](/docs/getting-started/)。稳定版本发布前，接口和存储格式可能发生变化。
:::
